...
import { GetNotifications, sendDataToBackend } from './services/https/index'; // นำเข้าฟังก์ชัน GetNotifications และ sendDataToBackend
...
const HelpCenterPage = () => {
    ...
    // ฟังก์ชัน handleSubmit ที่ปรับปรุง
