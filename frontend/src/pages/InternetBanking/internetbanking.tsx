...
const Component = () => {
  return (
    <div className="container">
      <h2>internetbanking Page</h2>
      <p>This is the internetbanking content.</p>
      <div className="rectangle" style={{ width: 626, height: 136, left: 130, top: 233 }} />
      <div className="text" style={{ left: 288, top: 277 }}>PromptPay</div>
      ...
      <div className="rectangle" style={{ width: 626, height: 136, left: 130, top: 539 }} />
      <div className="rectangle" style={{ width: 626, height: 136, left: 130, top: 695 }} />
      <div className="text" style={{ left: 288, top: 427 }}>Bank1</div>
      <div className="text" style={{ left: 909, top: 253 }}>Flight</div>
      <div className="text" style={{ left: 288, top: 577 }}>Bank2</div>
      <div className="text" style={{ left: 288, top: 733 }}>Bank3</div>

      <div className="icon" style={{ left: 157, top: 251 }} />
      <div className="icon" style={{ left: 156, top: 395 }} />
      <div className="icon" style={{ left: 156, top: 557 }} />
      <div className="icon" style={{ left: 156, top: 713 }} />
    
      <Link to="/QRCode" className="button" style={{ left: 610, height: 15, top: 318 }}>Click</Link>
      <div className="button" style={{ left: 610,height: 15, top: 466 }}>Click</div>
      <div className="button" style={{ left: 610,height: 15, top: 624 }}>Click</div>
      <div className="button" style={{ left: 610,height: 15, top: 772 }}>Click</div>
